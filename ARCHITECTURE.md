...
1. Створення структури репозиторію
2. Реалізація інтерфейсів (без логіки)
3. Додавання логування та JSON-схем
4. Інтеграція evaluation
5. Формування learning loop
